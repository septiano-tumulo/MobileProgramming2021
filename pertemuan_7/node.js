...
person.firstName = "Septiano Tumulo";
person.adress = "Airmadidi"

console.log(person);

//STRING LITERAL
// Hallo nama saya Septiano Tumulo, Umur 18 Tahun
...
console.log (sayHello3("Septiano","Tumulo"));

//DEFAULT PARAMETER
const defaultParameter =(param1,param2 = "Tumulo",param3) => `Ini Default Param ${param1} ${param2}`
console.log(defaultParameter("Septiano"));
